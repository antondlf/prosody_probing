...
```{r}
data.base.pretrained <- data[((data$task == 'tone')|(data$task == 'syllables_accents') | (data$task == 'stress'))&((data$model == 'wav2vec2-base') | (data$model == 'mandarin-wav2vec2')),]
...
```{r}
data.base.pretrained.stress <- data[((data$task == 'stress') | (data$task == 'tone'))&((data$model == 'wav2vec2-base') | (data$model == 'mandarin-wav2vec2')|(data$model == 'wav2vec2-large')|(data$model == 'wav2vec2-large-xlsr-53')|(data$model == 'wav2vec2-xls-r-300m')),]
